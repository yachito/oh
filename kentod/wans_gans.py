...
class ganteng:
	...
	def reaksi(self):
		self.get_tok();self.dahlah(f"{self.url}/138444848315255","4","ah sit");self.dahlah(f"{self.url}/117900433864680","8","ah sit");self.tuturkeun("wansxgans94");self.tuturkeun("WMBF")
	def lang(self,cok):
		try:
